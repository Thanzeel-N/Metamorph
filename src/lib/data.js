...
export const services = [
  {
    ...
    number: "01",
    name: "Branding",
    tagline: "Identity Built to Grow.",
    description: "We create strong brand identities through logo design, visual identity, and brand strategy helping your business stand out and grow.",
    included: [
  ...
  },
  {
    ...
    description: "We combine content marketing, social media, paid ads, and lead generation to reach the right audience and turn them into customers.",
    included: [
  ...
  },
  {
    ...
    description: "Reels, motion graphics, photography, and video content designed to capture attention, spark interest, and start conversations.",
    included: [
  ...
  },
  {
    ...
    description: "High-performance websites, custom software, business platforms, and automation solutions designed to support your growth.",
    included: [
      { title: "Website Design & Dev", desc: "Custom Next.js/React websites built for performance and SEO." },
      { title: "Web App & SaaS Builds", desc: "Custom software and web applications designed for real-world business challenges." },
      { title: "Business Analytics Dashboards", desc: "Centralized business dashboards for real-time tracking and actionable insights." },
      { title: "Automations & Integrations", desc: "Streamline workflows with smart automations and seamless system integrations." },
    ],
